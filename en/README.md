...
| [0024](./rfcs/0024-controlled-child-processes-and-stdio.md) | Controlled child processes and multiplexed standard I/O | Proposed | process, stdin, stdout, stderr, timeout, termination, MCP | Add a shell-free long-lived child handle with bounded queued stdin and multiplexed output/exit events. |
