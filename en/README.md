...
| [0022](./rfcs/0022-structured-http-client-and-host-runtime.md) | Structured HTTP client and toolchain-owned host runtime | Proposed | HTTP, HTTPS, TLS, standard library, host runtime | Add a bounded structured HTTPS client while keeping native FFI inside the toolchain runtime. |
