...
| [0029](./rfcs/0029-bounded-utc-cron-schedule-calculation.md) | Bounded UTC cron schedule calculation | Proposed | cron, scheduling, time, Agent, bounds, browser WASM | Parse bounded five-field UTC schedules and calculate deterministic matching minutes without a process-global scheduler. |
