...
| [0023](./rfcs/0023-pull-based-http-streaming-and-sse.md) | Pull-based HTTP text streaming and SSE | Proposed | HTTP, HTTPS, streaming, SSE, cancellation, timeout | Add bounded synchronous text/SSE pulls and cooperative cancellation without introducing async syntax. |
