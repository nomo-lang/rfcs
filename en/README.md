...
| [0014](./rfcs/0014-semver-resolution-and-conflict-explanations.md) | Semantic version resolution and conflict explanations | Proposed | semver, resolver, lockfile | Add deterministic single-version solving, lock semantics, and traceable conflict explanations. |
| [0015](./rfcs/0015-source-defined-standard-library-and-intrinsics.md) | Source-defined standard library and controlled intrinsic identities | Proposed | standard library, intrinsic, bootstrap | Move expressible library code into Nomo source and constrain minimal intrinsics with a toolchain manifest. |
...
| [0018](./rfcs/0018-package-signing-provenance-and-transparency.md) | Package signing, provenance, and transparency | Proposed | signing, provenance, registry | Verify publisher authorization and registry-history consistency beyond checksums. |
| [0019](./rfcs/0019-typed-ffi-handles-callbacks-and-bindings.md) | Typed FFI handles, callbacks, and bindings | Proposed | FFI, callback, C ABI | Extend the C boundary with nominal handles, explicit nullability, restricted callbacks, and reviewable bindings. |
