...
| [0042](./rfcs/0042-windows-arm64-preview-platform-support.md) | Windows ARM64 Preview platform support | Proposed | Not implemented | Windows 11, ARM64, target triple, MSVC ABI, release | Require native ARM64 build/run/release parity and ecosystem evidence; x64-to-ARM64 cross-build never substitutes for native runtime tests. |
| [0043](./rfcs/0043-c99-backend-optimization-and-c-cpp-performance-parity.md) | C99 backend optimization and C/C++ performance parity | Proposed | Not implemented | C99 backend, release mode, CFG MIR, proof-based optimization, C/ISO C++20 benchmark | Add a semantics-preserving release optimizer and require two qualified batches to meet frozen C, ISO C++20, and main-relative statistical gates. |
