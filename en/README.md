...
| [0028](./rfcs/0028-bounded-json-rpc-and-newline-stdio-framing.md) | Bounded JSON-RPC and newline-framed standard I/O | Proposed | JSON-RPC, MCP, stdio, framing, process, JSON, Agent | Validate bounded JSON-RPC 2.0 envelopes and decode newline-framed stdio incrementally with opaque value state. |
