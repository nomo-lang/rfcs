...
| [0025](./rfcs/0025-structured-json-values-and-construction.md) | Structured JSON values, access, and construction | Proposed | JSON, standard library, Agent, Unicode, limits, C backend, browser WASM | Keep `JsonValue` opaque while adding bounded traversal and safe construction with native/browser parity. |
