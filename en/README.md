...
| [0041](./rfcs/0041-canonical-implicit-void-return-declarations.md) | Canonical implicit `void` return declarations | Proposed | Not implemented | function declarations, methods, suspend, interfaces, extern, formatter, LSP | Omit `-> void` canonically on declarations while preserving explicit parser compatibility and complete callable/type/value uses. |
