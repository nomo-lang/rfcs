...
| [0030](./rfcs/0030-collection-literals-indexing-and-ordered-map.md) | Collection literals, indexing, and ordered Map | Proposed | arrays, indexing, COW, generics, map, determinism, Agent | Add inferred array literals, checked COW-safe indexing, and one insertion-ordered generic Map without duplicating it as HashMap. |
