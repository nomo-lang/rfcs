...
| [0022](./rfcs/0022-structured-http-client-and-host-runtime.md) | 结构化 HTTP Client 与工具链托管 Host Runtime | Proposed（已提案） | HTTP、HTTPS、TLS、标准库、host runtime | 增加受限的结构化 HTTPS client，并把 native FFI 保留在工具链 runtime 内。 |
