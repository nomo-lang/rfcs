...
| [0028](./rfcs/0028-bounded-json-rpc-and-newline-stdio-framing.md) | 受限 JSON-RPC 与换行分帧标准 I/O | Proposed（已提案） | JSON-RPC、MCP、stdio、framing、process、JSON、Agent | 验证受限 JSON-RPC 2.0 envelope，并以 opaque value state 增量解码换行分帧 stdio。 |
